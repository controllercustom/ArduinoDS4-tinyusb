# patch_renesas_core.windows.ps1 - apply the ArduinoXInput-tinyusb
...
'@
        New    = @'
// XR4 (ArduinoXInput-tinyusb): weak hooks that let a library contribute a
// custom vendor-class interface and/or override VID/PID. Implemented strongly
// by the ArduinoXInput-tinyusb Renesas backend; absent otherwise.
...
Write-Host '    --library <path-to-ArduinoXInput-tinyusb> <sketch>'
